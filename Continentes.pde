...
void escenaAsia() {
  ...
  textSize(35);
  fill(50);
  text(asiaTit1, width / 2, 995, 1150, width / 1.75);
  ...
  textSize(20);
  fill(50);
  text(asiaInf11, width / 2, 1050, 1150, width / 1.75);
  ...
  textSize(20);
  fill(50);
  text(asiaInf12, width / 2, 1155, 1150, width / 1.75);
  ...
  textSize(20);
  fill(50);
  text(asiaInf13, width / 2, 1200, 1150, width / 1.75);

  String asiaTit2 = "CARACTERÍSTICAS FÍSIO-NATURALES DE ASIA";
  textSize(35);
  fill(50);
  text(asiaTit2, width / 2, 1345, 1150, width / 1.75);
  ...
  textSize(20);
  fill(50);
  text(asiaInf21, width / 2, 1400, 1150, width / 1.75);
  ...
  textSize(20);
  fill(50);
  text(asiaInf22, width / 2, 1500, 1150, width / 1.75);
  ...
  textSize(20);
  fill(50);
  text(asiaInf23, width / 2, 1635, 1150, width / 1.75);

  String asiaTit3 = "CULTURA Y RELIGIÓN EN ASIA";
  textSize(35);
  fill(50);
  text(asiaTit3, width / 2, 1720, 1150, width / 1.75);
  ...
  textSize(20);
  fill(50);
  text(asiaInf31, width / 2, 1775, 1150, width / 1.75);
  ...
  textSize(20);
  fill(50);
  text(asiaInf32, width / 2, 1880, 1150, width / 1.75);

  String asiaTit4 = "ACTIVIDADES ECONÓMICAS DE ASIA";
  textSize(35);
  fill(50);
  text(asiaTit4, width / 2, 2010, 1150, width / 1.75);
  ...
  textSize(20);
  fill(50);
  text(asiaInf41, width / 2, 2065, 1150, width / 1.75);

  String asiaFuente = "Fuente: https://humanidades.com/asia/";
  textSize(15);
  fill(50);
  text(asiaFuente, width / 2, 2240, 1150, width / 1.75);
}
...
void escenaOceania() {
  ...
  textSize(35);
  fill(50);
  text(oceaniaTit1, width / 2, 995, 1150, width / 1.75);
  ...
  textSize(20);
  fill(50);
  text(oceaniaInf11, width / 2, 1050, 1150, width / 1.75);
  ...
  textSize(20);
  fill(50);
  text(oceaniaInf12, width / 2, 1140, 1150, width / 1.75);
  ...
  textSize(20);
  fill(50);
  text(oceaniaInf13, width / 2, 1225, 1150, width / 1.75);

  String oceaniaTit2 = "CARACTERÍSTICAS FÍSIO-NATURALES DE OCEANÍA";
  textSize(35);
  fill(50);
  text(oceaniaTit2, width / 2, 1345, 1150, width / 1.75);
  ...
  textSize(20);
  fill(50);
  text(oceaniaInf21, width / 2, 1400, 1150, width / 1.75);
  ...
  textSize(35);
  fill(50);
  text(oceaniaTit4, width / 2, 2010, 1150, width / 1.75);
  ...
  textSize(20);
  fill(50);
  text(oceaniaInf41, width / 2, 2065, 1150, width / 1.75);

  String oceaniaFuente = "Fuente: https://humanidades.com/oceania/";
  textSize(15);
  fill(50);
  text(oceaniaFuente, width / 2, 2240, 1150, width / 1.75);
}
